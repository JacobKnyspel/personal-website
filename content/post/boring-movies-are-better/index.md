...
{{< math >}}
$$\beta = \frac{\sum{\left(x_i-{\bar{x}}\right)\left(y_i-{\bar{y}}\right)}}{\sum{\left(x_i-{\bar{x}}\right)^2}} = \frac{n\sum{x_i}{y_i}-\sum{x_i}\sum{y_i}}{n\sum{x_{i}^{2}}-\left(\sum{x_i}\right)^2}$$
