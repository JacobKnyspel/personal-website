...
Based on these outputs, we can say that there a small yet significant negative relationship is observed between movie year and movie rating when using OLS estimation, {{< math >}}$t\left{5560}\right = -22.74, p < .001, \eta^2 = .09, 95% CI${{< /math >}}
