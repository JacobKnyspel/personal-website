...
{{< math >}}
$$\beta = \frac{\sum_{i=1}^{n}{\left(x_i-{\bar{x}}\right)\left(y_i-{\bar{y}}\right)}}{\sum_{i=1}^{n}{\left(x_i-{\bar{x}}\right)^2}} = \frac{n\sum{x_i}{y_i}-\sum{x_i}\sum{y_i}}{n\sum{x_{i}^{2}}-\left(\sum{x_i}\right)^2}$$
