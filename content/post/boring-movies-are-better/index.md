...
Based on these outputs, we can say that a small yet significant negative relationship is observed between movie year and movie rating when using OLS estimation, {{< math >}}$t\left(5560\right)=-22.74${{< /math >}}, {{< math >}}$p<.001${{< /math >}},  {{< math >}}$\eta^2=.09${{< /math >}}, {{< math >}}$95\% CI = \left[.07, .10\right]${{< /math >}}
